...
from .drivers.coolled.colors import default_background, resolve_color
...
def render_image(entity_id, device, service, hass):
    ...
    for element in payload:
        ...
        if elem_type == "line":
            ...
            fill = getIndexColor(element['fill']) if 'fill' in element else getIndexColor("on")
        ...
        if elem_type == "rectangle":
            ...
            rect_outline = getIndexColor(element['outline']) if 'outline' in element else getIndexColor("on")
        ...
        if elem_type == "rectangle_pattern":
            ...
            outline = getIndexColor(element['outline']) if 'outline' in element else getIndexColor("on")
            width = element.get('width', 1)
            radius = element['radius'] if 'radius' in element else 10 if 'corners' in element else 0
            corners = rounded_corners(element['corners']) if 'corners' in element else rounded_corners("all") if 'radius' in element else (False, False, False, False)
        ...
        if elem_type == "icon":
            ...
            fill = getIndexColor(element['color']) if 'color' in element \
                else getIndexColor(element['fill']) if 'fill' in element else getIndexColor("on")
