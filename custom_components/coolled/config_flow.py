"""Config flow for CoolLED Bluetooth integration."""
...
from .coolled_ble import CoolledBluetoothDeviceData
...
class Discovery:
    """Discovered CoolLED device."""

    title: str
    discovery_info: BluetoothServiceInfoBleak
    device: CoolledBluetoothDeviceData


def _title(discovery_info: BluetoothServiceInfoBleak, device: CoolledBluetoothDeviceData) -> str:
    return device.title or device.get_device_name() or discovery_info.name or "CoolLED"


class CoolledConfigFlow(ConfigFlow, domain=DOMAIN):
    """Handle CoolLED config flow."""

    VERSION = 1

    def __init__(self) -> None:
        self._discovery_info: BluetoothServiceInfoBleak | None = None
        self._discovered_device: CoolledBluetoothDeviceData | None = None
    ...
    def async_get_options_flow(config_entry):
        return CoolledOptionsFlowHandler()
...
class CoolledOptionsFlowHandler(OptionsFlowWithReload):
    """CoolLED options flow."""
