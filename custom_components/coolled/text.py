"""Support for CoolLED display text entity."""
...
from .coolled_ble import send_text
...
async def async_setup_entry(
    ...
    async_add_entities([CoolledDisplayText(hass, entry)])


class CoolledDisplayText(RestoreText):
    """Text shown on the CoolLED sign."""
    ...
    def __init__(self, hass: HomeAssistant, entry: ConfigEntry) -> None:
        ...
        self._attr_unique_id = f"coolled_{self._identifier}_display_text"
